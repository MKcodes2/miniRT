...
We provide the option to interact LIVE with the Camera, Light and Objects so that you see directly the modification on the rendered image. (_For "How to" check the corresponding section in [Usage 🚀 ](https://github.com/flavify/MiniRT?tab=readme-ov-file#-how-to-move-the-scene-in-the-interactive-mode)_)
...
&nbsp; 💁‍♀️ &nbsp; _For analytical info on how to run the different modes, check out the [Usage 🚀 ](https://github.com/flavify/MiniRT?tab=readme-ov-file#--usage) section below ⬇️._
